...
export default function ApplicationFees() {
  ...
  const applicationFees = {
    ...
    bankDetails: {
      ...
      accountName: 'University Application Account',
      swiftCode: 'UNIVXX22'
    }
  };
    ...
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center space-x-2 mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Application Fees</h2>
        </div>

        <div className="border-t border-b border-gray-200 py-4 mb-6">
          <div className="flex justify-between items-center mb-4">
            <span className="text-gray-600">Application Fee Amount:</span>
            <span className="text-lg font-semibold text-primary">${applicationFees.amount.toFixed(2)}</span>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="font-medium">{applicationFees.bankDetails.bankName}</p>
              </div>
              <div>
                <p className="text-gray-600">Account Number:</p>
                <p className="font-medium">{applicationFees.bankDetails.accountNumber}</p>
              </div>
              <div>
                <p className="text-gray-600">Account Name:</p>
                <p className="font-medium">{applicationFees.bankDetails.accountName}</p>
              </div>
              <div>
                <p className="text-gray-600">Swift Code:</p>
                <p className="font-medium">{applicationFees.bankDetails.swiftCode}</p>
              </div>
            </div>
          </div>
        </div>
